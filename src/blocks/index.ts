import { Extension } from '../views/Page'
// import fs from 'fs'
...
export async function getToolBoxXml(extensions: Extension[]) {
  ...
  if (extensions.indexOf('Web General') !== -1) {
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'web', 'imports', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'web', 'variables', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'web', 'turtle', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'web', 'graphs', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'web', 'random', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'web', 'processing', 'toolbox.xml'),
    // )
  }
  ...
  if (extensions.indexOf('CircuitPython General') !== -1) {
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'circuitpython', 'basic', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'variables', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'circuitpython', 'digital', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'circuitpython', 'analog', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'circuitpython', 'neopixel', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'circuitpython', 'touch', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'circuitpython', 'servo', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'circuitpython', 'audio', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'circuitpython', 'pwm', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'circuitpython', 'dotstar', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'circuitpython', 'advanced', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'circuitpython', 'cpx', 'toolbox.xml'),
    // )
  }
  ...
  if (extensions.indexOf('micro:bit General') !== -1) {
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'basic', 'toolbox.xml'),
    // )
    ;(await import('./microbit/variables/definitions')).default(Blockly.Blocks)
    ;(await import('./microbit/variables/generators')).default(Blockly.Python as any)
    // toolBoxXml += fs.readFileSync(
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'display', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'buttons', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'accelerometer', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'compass', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'radio', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'speech', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'music', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'microphone', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'neopixel', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'pins', 'toolbox.xml'),
    // )
  }
  ...
  if (extensions.indexOf('scrollbit') !== -1) {
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'scrollbit', 'toolbox.xml'),
    // )
  }
  ...
  if (extensions.indexOf('GiggleBot') !== -1) {
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'gigglebot', 'toolbox.xml'),
    // )
  }
  ...
  if (extensions.indexOf('edubit') !== -1) {
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'edubit', 'toolbox.xml'),
    // )
  }
  if (extensions.indexOf('DriveBit') !== -1) {
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'DriveBit', 'toolbox.xml'),
    // )
  }
  if (extensions.indexOf('BitBotXL') !== -1) {
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'BitBotXL', 'toolbox.xml'),
    // )
  }
  if (extensions.indexOf('MoveMini') !== -1) {
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'MoveMini', 'toolbox.xml'),
    // )
  }
  if (extensions.indexOf('Minibit') !== -1) {
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'Minibit', 'toolbox.xml'),
    // )
  }
  ...
  if (extensions.indexOf('Pi General') !== -1) {
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'pi', 'basic', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'pi', 'variables', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'pi', 'minecraft', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'pi', 'gpiozero', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'pi', 'sonicpi', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'pi', 'pimoroni', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'pi', 'requests', 'toolbox.xml'),
    // )
    ...
    // toolBoxXml += fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'pi', 'picamera', 'toolbox.xml'),
    // )
  }
...
export function getBeforeScript(extensions: Extension[]) {
  if (extensions.indexOf('scrollbit') !== -1) {
    ...
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'scrollbit', 'scrollbit.py'),
    // )
  }
  if (extensions.indexOf('GiggleBot') !== -1) {
    // return fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'gigglebot', 'gigglebot.py'),
    // )
  }
  if (extensions.indexOf('Minibit') !== -1) {
    // return fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'Minibit', 'Minibit.py'),
    // )
  }
  //Automated Scripts under here
  if (extensions.indexOf('edubit') !== -1) {
    // return fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'edubit', 'edubit.py'),
    // )
  }
  if (extensions.indexOf('DriveBit') !== -1) {
    // return fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'DriveBit', 'DriveBit.py'),
    // )
  }
  if (extensions.indexOf('BitBotXL') !== -1) {
    // return fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'BitBotXL', 'BitBotXL.py'),
    // )
  }
  if (extensions.indexOf('MoveMini') !== -1) {
    // return fs.readFileSync(
    //   path.join(__dirname, '..', '..', 'src', 'blocks', 'microbit', 'MoveMini', 'MoveMini.py'),
    // )
  }
}
